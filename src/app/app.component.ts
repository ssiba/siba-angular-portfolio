...
export class AppComponent implements OnInit {
	...
	ngOnInit(): void {
		...
		this.titleService.setTitle(
			"Siba Sankar Gouda | Experienced Front-End Developer | JavaScript, Angular , Angular Material|Software Engineer"
		);
